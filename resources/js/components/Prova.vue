    ...
    <div>
        ...
        <div class="single-card-restaurant">
            ...
            <div class="single-card-restaurant-top">
                <img v-if="results.pic_url.length > 20"
            ...
            <div class="single-card-restaurant-bottom">
                <div class="single-restaurant-misc">
                    <h5 class="restaurant-name"><strong>Nome:</strong> {{ results.business_name }}</h5>
                    <p class="restaurant-description"><strong>Descrizione:</strong> {{ results.description }}</p>
                    <p class="restaurant-address"><strong>Indirizzo:</strong> {{ results.address }}</p>
                    <p class="restaurant-hours"><strong>Orari:</strong> {{ results.opening_hours }}</p>
