...
<div class="user-wrapper social-distancing">
    ...
    <div class="user-container container">
        ...
        <div class="user-main-content" id="root">
            ...
            <div class="user-restaurant-card" href="{{ route('restaurants.show', ['restaurant' => $userRestaurant->slug])}}">

                <div class="img-container">
                    <img src="{{asset($userRestaurant->pic_url)}}" alt="immagine ristorante">
                </div>

                <a href="{{ route('restaurants.show', ['restaurant' => $userRestaurant->slug])}}"> {{$userRestaurant->business_name}}</a>
                ...
                <div class="user-restaurant-button">
                    ...
                    <form action="{{ route('show.orders', ['restaurant' => $userRestaurant->slug])}}">
                        <button type="submit" class="user-button border-none">Ordini</button>
                    </form>

                    <form action="{{route('restaurants.edit', ['restaurant' => $userRestaurant->slug])}}">
                        <button type="submit" class="user-button border-none">Modifica</button>
                    </form>

                    <form action="{{route('restaurants.destroy',['restaurant' => $userRestaurant->slug])}}" method="post">
                        @csrf
                        @method('DELETE')
