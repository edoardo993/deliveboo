...
<div class="user-wrapper social-distancing">
    ...
    <div class="user-container container">
        ...
        <div class="user-main-content" id="root">
            ...
            <div class="user-restaurant-card" href="{{ route('restaurants.show', ['restaurant' => $userRestaurant->id])}}">

                <div class="img-container">
                    <img src="{{asset($userRestaurant->pic_url)}}" alt="immagine ristorante">
                </div>

                <a href="{{ route('restaurants.show', ['restaurant' => $userRestaurant->id])}}"> {{$userRestaurant->business_name}}</a>
                ...
                <div class="user-restaurant-button">
                    ...
                    <form action="{{ route('show.orders', ['restaurant' => $userRestaurant->id])}}">
